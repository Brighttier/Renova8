    ...
    <div className="min-h-screen flex bg-[#F9F6F0] font-sans text-[#4A4A4A]">
      ...
      >
        ...
        <div className="p-4 border-t border-[#F9F6F0]">
            {/* Tokens Display with Buy Now */}
            <div className={`bg-gradient-to-r from-[#D4AF37]/10 to-[#D4AF37]/5 rounded-xl border border-[#D4AF37]/20 mb-4 ${isSidebarCollapsed ? 'p-2' : 'p-3'}`}>
                ...
                <button
                    ...
                    className={`w-full mt-2 bg-gradient-to-r from-[#D4AF37] to-[#B8963A] text-white font-semibold rounded-lg hover:shadow-md transition-all ${isSidebarCollapsed ? 'py-1.5 text-[10px]' : 'py-1.5 text-xs'}`}
